  ...
  setting : {
    ...
    prompt : {
      realtime : { text : function(){return Locale.setting.prompt.realtime[APPLOC]},
        de : "Mit realistischer Zeit spielen? (nicht empfohlen)",
        en : "Play with realistic time? (not recommended)",
      },
      ...
      harsh : { text : function(){return Locale.setting.prompt.harsh[APPLOC]},
        de : "Besonders bestrafende Ereignisse aktivieren?",
        en : "Play with CW Events?",
      },
